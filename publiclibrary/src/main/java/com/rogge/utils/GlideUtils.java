 ...
 * [Tips]
 *
 * @author Created by Rogge on 2016/12/28.
 * @since 1.0.0
 */
...
public abstract class GlideUtils {
    ...
    public static <T> void loadImage(T context, final String url, final ImageView imageView) {
        ...
        if (type != null) {
            type.asBitmap();
            type.placeholder(R.drawable.bg_bg_gray);   //占位符
            type.error(R.drawable.bg_bg_gray);    //图片加载失败显示图片
        }
    ...
    public static void loadImageFormVideo(String url, ImageView imageView) {
        Glide.with(imageView.getContext()).load(url)
                .override((int) ScreenUtils.dip2px(150), (int) ScreenUtils.dip2px(150))
                .placeholder(R.drawable.bg_bg_gray)
                .dontAnimate()
                .into(imageView);
    }
